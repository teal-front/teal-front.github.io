/**
 * from: https://github.com/yhanwen/fsm
 */
...
(function(){
    ...
    S.augment(FSM, S.EventTarget, proto); // =>  jQuery.extend(FSM.prototype, S.EventTarget, proto)
    ...
    S.augment(SlideMenu,S.EventTarget,{ //参考46行的写法
        setText:function(){
            var _this = this,
            select = _this.select;
