    ...
    (function () {
        var $ = {
            ...
            specialDates: null, specialDays: null, disabledDates: null, disabledDays: null, onpicking: null, onpicked: null, onclearing: null, oncleared: null, ychanging: null, ychanged: null, Mchanging: null, Mchanged: null, dchanging: null, dchanged: null, Hchanging: null, Hchanged: null, mchanging: null, mchanged: null, schanging: null, schanged: null, eCont: null, vel: null, elProp: "", errMsg: "", quickSel: [], has: {}, getRealLang: function () {
                return {name: "zh-cn", charset: "UTF-8"};
            }};
        WdatePicker = U;
        ...
        //A = $.$dpPath || J();
        if ($.$wdate)K(require.resolve("WdatePickerStyle"));
        V = Y;
        if ($.$crossFrame) {
            try {
        ...
        function I(G, _) {
            ...
            function E(I, H) {
                ...
                //I.lang = K.name;
                I.skin = H.skin;
                var J = ["<head><script>", "", "var $d, $dp, $cfg=document.cfg, $pdp = parent.$dp, $dt, $tdt, $sdt, $lastInput, $IE=$pdp.ie, $FF = $pdp.ff,$OPERA=$pdp.opera, $ny, $cMark = false;", "if($cfg.eCont){$dp = {};for(var p in $pdp)$dp[p]=$pdp[p];}else{$dp=$pdp;};for(var p in $cfg){$dp[p]=$cfg[p];}", "", "</script>"];
                if (E)J[1] = "document.domain=\"" + G + "\";";
                for (var L = 0; L < C.length; L++)if (C[L].name == H.skin)J.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + require.resolve("datapicker") + "\"/>");
                J.push("<script type=\"text/javascript\" src=" + require.resolve("zh-cn") + " charset=\"gb2312\"></script>");
                J.push("<script type=\"text/javascript\" src=" + require.resolve("calendar1") + " charset=\"gb2312\"></script>");
